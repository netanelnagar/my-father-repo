      ...
      <div className="layout-container flex h-full grow flex-col">
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f3f4] px-4 sm:px-6 lg:px-10 py-3">
          <div className="flex items-center gap-4 text-[#111618]">
            ...
            <h2 className="text-[#111618] text-base sm:text-lg font-bold leading-tight tracking-[-0.015em]">Ascend Home Lifts</h2>
          </div>
          <div className="flex flex-1 justify-end gap-3 sm:gap-8">
            <nav className="hidden md:flex items-center gap-6 lg:gap-9">
              ...
              <a className="text-[#111618] text-sm font-medium leading-normal" href="#">Solutions</a>
            ...
            <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-9 sm:h-10 px-3 sm:px-4 bg-[#13a4ec] text-white text-sm font-bold leading-normal tracking-[0.015em]">
